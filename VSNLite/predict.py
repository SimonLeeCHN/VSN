...
if __name__ == "__main__":
    ...
    net = torch.nn.Module()
    if args.model == 'FCNED':
        net = FCNED(n_channels=3, n_classes=1)
    elif args.model == 'VSN':
        net = VSN(n_channels=3, n_classes=1)
    elif args.model == 'VSNLite1M':
        net = VSNLite1M(n_channels=3, n_classes=1)
    elif args.model == 'VSNLite1MA':
        net = VSNLite1MA(n_channels=3, n_classes=1)
    elif args.model == 'VSNLite1MB':
        net = VSNLite1MB(n_channels=3, n_classes=1)
    elif args.model == 'VSNLite4M':
        net = VSNLite4M(n_channels=3, n_classes=1)
    elif args.model == 'VSNLite1MC':
        net = VSNLite1MC(n_channels=3, n_classes=1)
