...
class ConvBlock(nn.Module):
    ...
    def __init__(self, in_channels, mid_channels, out_channels):
        ...
        #     nn.Conv2d(in_channels, mid_channels, kernel_size=1, stride=1, padding=0, bias=True),
        #     nn.InstanceNorm2d(mid_channels),
        #     nn.ReLU(inplace=True)
        # )
        # self.conv2 = nn.Sequential(
        #     nn.Conv2d(mid_channels, mid_channels, kernel_size=3, stride=1, padding=1, bias=True),
        #     nn.InstanceNorm2d(mid_channels),
        #     nn.ReLU(inplace=True)
        # )
        # self.conv3 = nn.Sequential(
        #     nn.Conv2d(mid_channels, out_channels, kernel_size=1, stride=1, padding=0, bias=True),
...
# End of VSNLite1MD components define #


class VSNLite1MD(nn.Module):
    def __init__(self, n_channels, n_classes):
        super(VSNLite1MD, self).__init__()
